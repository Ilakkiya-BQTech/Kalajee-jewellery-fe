...
const initialData = [
  ...
  { id: 7, name: 'Earring 7', price: 10000, details: 'Details of Item 7', status: 'Available', image: 'https://images-static.nykaa.com/media/catalog/product/f/1/f112fc7jwj446.jpg' },
  { id: 8, name: 'Earring 8', price: 20000, details: 'Details of Item 8', status: 'Sold', image: 'https://images.cltstatic.com/media/product/350/AE00353-SS0000-antique-nanammas-temple-visit-earrings-in--silver-prd-1-model.jpg' },
  { id: 9, name: 'Earring 9', price: 30000, details: 'Details of Item 9', status: 'Available', image: 'https://img.tatacliq.com/images/i11/437Wx649H/MP000000017654181_437Wx649H_202305240245571.jpeg' },
];
    ...
    <div className="stock">
      <div className="item-container">
        {selectedItem ? (
          ...
          <Para text="Select an item from the table" />
        )}
      </div>
