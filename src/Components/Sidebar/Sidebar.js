...
//     <div className="layout-container">
//       <div className='navbar'>
//         <img src={Logo} alt='gail-logo' className='logo'/>
//         <div className='nav-img-container'>
//           <img src={Nav} alt='kalajee jewellery' className='nav-img'/>
//         </div>
...
//         <div className='menu'>
//           <ul>
//             <NavLink to="/markers-map" onClick={closeSidebar} className={({ isActive }) => isActive ? 'active' : ''}><li>Boxes</li></NavLink>
//             <div className='line-separate'></div>
//             <NavLink to="/markers" onClick={closeSidebar} className={({ isActive }) => isActive ? 'active' : ''}><li>Current Stock</li></NavLink>
//             <div className='line-separate'></div>
//             <div onClick={handleSignOut}><li onClick={closeSidebar}>Sign out</li></div>
//           </ul>
//         </div>
